...
const COMMERCIALS = [
  ...
  { id: "meji-meji-collab", title: "Meji Meji", meta: "Collab Commercial", posterAt: 1 },
  { id: "ldm-clo", title: "LDM CLO", meta: "Collab Commercial", posterAt: 1 },
  { id: "shine-cartel", title: "The Shine Cartel", meta: "Beauty Commercial", posterAt: 1 },
  { id: "streetsouk", title: "Streetsouk", meta: "Collab Commercial", posterAt: 1 },
].map((c) => ({
  ...c,
